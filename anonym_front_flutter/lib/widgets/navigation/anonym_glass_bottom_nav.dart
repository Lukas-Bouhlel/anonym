...
/// Glass bottom navigation bar for the authenticated shell.
///
/// Expects index mapping: `0=home`, `1=chat`, `2=search`, `3=profile`.
///
/// {@tool snippet}
/// AnonymGlassBottomNav(
///   currentIndex: currentTab,
///   onTap: (index) => setState(() => currentTab = index),
///   onCenterTap: _openCreateSheet,
/// )
/// {@end-tool}
///
/// Error cases:
/// - If [currentIndex] is outside `0..3`, no item is highlighted.
/// - Missing `assets/icons/anonym_logo.svg` can throw an asset load error.
class AnonymGlassBottomNav extends StatelessWidget {
  const AnonymGlassBottomNav({
    super.key,
